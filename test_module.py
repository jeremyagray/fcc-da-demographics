...
class DemographicAnalyzerTestCase(unittest.TestCase):
    ...
    def test_percentage_bachelors(self):
        ...
        self.assertAlmostEqual(
            actual,
            expected,
            "Expected different value for percentage with Bachelors degrees.",
        )
    ...
    def test_higher_education_rich(self):
        ...
        self.assertAlmostEqual(
            actual,
            expected,
            "Expected different value for percentage with higher education"
            " that earn >50K.",
        )
    ...
    def test_lower_education_rich(self):
        ...
        self.assertAlmostEqual(
            actual,
            expected,
            "Expected different value for percentage without higher education"
            " that earn >50K.",
        )
    ...
    def test_rich_percentage(self):
        ...
        self.assertAlmostEqual(
            actual,
            expected,
            "Expected different value for percentage of rich among those"
            " who work fewest hours.",
        )
    ...
    def test_highest_earning_country_percentage(self):
        ...
        self.assertAlmostEqual(
            actual,
            expected,
            "Expected different value for heighest earning country percentage.",
        )
